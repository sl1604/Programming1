...
age_answer = st.number_input('Insert your age in number:', min_value=0, max_value =98, step=1)

income_answer = st.selectbox(
    'What is your annual income?',
    ('Less than 10,000', '10,000 - 20,0000', '20,000-30,000', '30,000-40,000', '40,000-50,000', '50,000-75,000', '75,000-100,000', '100,000-150,000', '150,000+'))
